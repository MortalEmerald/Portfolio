(function ($) {
    ...
    var ajaxurl = raute_admin.ajax_url;
    var RauteNonce = raute_admin.ajax_nonce;

    // Category Color
    $('#raute-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: raute_admin.upload_image,
            button: {
            text: raute_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'raute_notice_dismiss',
            '_wpnonce': RauteNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-raute-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-raute-notice').addClass('twp-installing');

        var data = {
            'action': 'raute_install_plugins',
            '_wpnonce': RauteNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = raute_admin.active
            var deactivate = raute_admin.deactivate
