...
if ( !function_exists('raute_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function raute_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('Raute_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'raute_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('Raute_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class Raute_Tab_Posts_Widget extends Raute_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'raute_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'raute'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'raute'),
                    'type'           => 'heading',
                ),
                'popular_post_title' => array(
                    'label'         => esc_html__('Popular Posts Title', 'raute'),
                    'type'          => 'text',
                    'default'          => esc_html__('Popular', 'raute'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'raute'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'select_image_size' => array(
                    'label' => esc_html__('Select Image Size Featured Post:', 'raute'),
                    'type' => 'select',
                    'default' => 'medium',
                    'options' => array(
                        'thumbnail' => esc_html__('Thumbnail', 'raute'),
                        'medium' => esc_html__( 'Medium', 'raute' ),
                        'large' => esc_html__( 'Large', 'raute' ),
                        'full' => esc_html__( 'Full', 'raute' ),
                        ),
                    
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'raute'),
                    'description'   => esc_html__('Number of words', 'raute'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'raute'),
                    'type'          => 'heading',
                ),
                'recent_post_title' => array(
                    'label'         => esc_html__('Recent Posts Title', 'raute'),
                    'type'          => 'text',
                    'default'          => esc_html__('Recent', 'raute'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'raute'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'raute'),
                    'type'            => 'heading',
                ),
                'comments_post_title' => array(
                    'label'         => esc_html__('Comments Posts Title', 'raute'),
                    'type'          => 'text',
                    'default'          => esc_html__('Comments', 'raute'),
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'raute'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'raute-tabbed', esc_html__( 'MP: Tab Posts Widget', 'raute' ), $opts, array(), $fields );
                        ...
                        <li tab-data="tab-popular" class="tab tab-popular active">
                            <a href="javascript:void(0)">
                                ...
                                <span class="fire-icon tab-icon">
                                    <?php raute_the_theme_svg('popular'); ?>
                                </span>
                        ...
                        <li tab-data="tab-comments" class="tab tab-comments">
                            <a href="javascript:void(0)">
                                ...
                                <span class="comment-icon tab-icon">
                                    <?php raute_the_theme_svg('comment-2'); ?>
                                </span>
