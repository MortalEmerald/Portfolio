<?php
if( !function_exists('raute_custom_taxonomy_field') ):

	// Add term page
    function raute_custom_taxonomy_field(){
        ...
        <div class="form-field">
            ...
            <label><?php esc_html_e('Feature Image', 'raute'); ?></label>
        ...
        <div class="form-field">
            ...
            <label><?php esc_html_e('Category Color', 'raute'); ?></label>
            
            <input type="text" name="raute-cat-color" id="raute-cat-color" value="">
...
add_action('category_add_form_fields', 'raute_custom_taxonomy_field', 10, 2);


if( !function_exists('raute_taxonomy_edit_meta_field') ):

	// Edit term page
    function raute_taxonomy_edit_meta_field($term){

        $twp_term_image = get_term_meta( $term->term_id, 'twp-term-featured-image', true );
        $twp_term_color = get_term_meta( $term->term_id, 'raute-cat-color', true ); ?>
        <tr>
            
            <th scope="row" valign="top"><label><?php esc_html_e('Feature Image', 'raute'); ?></label></th>
        ...
        <tr>
            ...
            <td><label><?php esc_html_e('Category Color', 'raute'); ?></label></td>

            <td><input type="text" name="raute-cat-color" id="raute-cat-color" value="<?php echo esc_attr( $twp_term_color ); ?>"></td>
...
add_action('category_edit_form_fields', 'raute_taxonomy_edit_meta_field', 10, 2);
...
if( !function_exists('save_taxonomy_color_class_meta') ):
    ...
    function save_taxonomy_color_class_meta( $term_id ){
        ...
        if( isset( $_POST['raute-cat-color'] ) ){

            update_term_meta(
                $term_id,
                'raute-cat-color',
                sanitize_hex_color( wp_unslash( $_POST[ 'raute-cat-color' ] ) )
            );
