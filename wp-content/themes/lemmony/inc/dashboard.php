                    ...
                    <div class="lemmony-dash-childs">
                        ...
                        <div class="lemmony-dash-child__item">
                            <div class="lemmony-dash-child__image">
                                <img src="<?php esc_attr_e( get_template_directory_uri() . '/assets/media/dashboard-child1.png' ); ?>" alt="<?php esc_attr_e( 'Lemmony Agency (soon)', 'lemmony' ); ?>" />
                            </div>
                            <div>
                                <h3>
                        ...
                        <div class="lemmony-dash-child__item">
                            <div class="lemmony-dash-child__image">
                                <img src="<?php esc_attr_e( get_template_directory_uri() . '/assets/media/dashboard-child2.png' ); ?>" alt="<?php esc_attr_e( 'Lemmony Magazine (soon)', 'lemmony' ); ?>" />
                            </div>
                            <div>
                                <h3>
