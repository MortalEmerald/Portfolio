...
<figure class="wp-block-image aligncenter size-full lemmony-animation" style="--lemmony-animation-name:lemmonyFadeInUp"><img src="<?php echo esc_url( lemmony_media("404.png") ); ?>" alt="" class="wp-image-3022"/></figure>
<!-- /wp:image -->
