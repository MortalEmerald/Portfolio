...
define('TORTOISE_THEME_URL','https://wwwows.com/product/tortoise-wordpress-theme/');
define('TORTOISE_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('TORTOISE_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'tortoise_admin_theme_page_more_features' ) ) {
	function tortoise_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Tortoise Premium', 'tortoise' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'tortoise' ); ?></p>
    <a href="<?php echo esc_url(TORTOISE_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Tortoise Premium', 'tortoise' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'tortoise_admin_theme_page_title' ) ) {
	function tortoise_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Tortoise WordPress Theme', 'tortoise' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Tortoise! Check all the theme features.', 'tortoise' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'tortoise' );?></h2>
</div>
<?php
	}
}    
 
// Tortoise admin page content   
if ( ! function_exists( 'tortoise_admin_theme_page' ) ) {
	function tortoise_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php tortoise_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span>Free</span> Tortoise features</h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(TORTOISE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'tortoise' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(TORTOISE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'tortoise' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(TORTOISE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'tortoise' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(TORTOISE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'tortoise' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(TORTOISE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'tortoise' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Premium</span> Tortoise features</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'tortoise' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Additional blocks</span> for Tortoise premium</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'tortoise' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'tortoise' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php tortoise_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'tortoise' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'tortoise' ); ?></p>
        <a href="<?php echo esc_url(TORTOISE_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'tortoise' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'tortoise' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'tortoise' ); ?></p>
        <a href="<?php echo esc_url(TORTOISE_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'tortoise' ); ?></a>
    </div>
</div>
<?php
	}
